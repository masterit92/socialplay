		...
		class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
			...
			public function after($title = '') {
				...
				if ( $this->error || ! $this->result ) {
					if ( $this->error )
						echo '<div class="error"><p>' . sprintf( kvalue($this->upgrader->strings, 'skin_update_failed_error'), $this->plugin_names[$this->i], $this->error ) . '</p></div>';
					else
						echo '<div class="error"><p>' . sprintf( kvalue($this->upgrader->strings, 'skin_update_failed'), $this->plugin_names[$this->i] ) . '</p></div>';
				...
				if ( ! empty( $this->result ) && ! is_wp_error( $this->result ) ) {
					echo '<div class="updated"><p>' . sprintf( kvalue($this->upgrader->strings, 'skin_update_successful'), $this->plugin_names[$this->i], 'jQuery(\'#progress-' . esc_js( $this->upgrader->update_current ) . '\').toggle();jQuery(\'span\', this).toggle(); return false;' ) . '</p></div>';
